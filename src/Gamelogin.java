...
{
    private javax.swing.JLabel Playlable;
    ...
    Gamelogin()
    {
        ...
        background.setIcon(new ImageIcon("banner.jpg"));
        background.setBounds(15,15,910,620);



        Playlable=new JLabel(new ImageIcon("Play.png"));
        Playlable.setBounds(378, 230, 164, 164);
